<%-- 
    ...
    Created on : 1 Jul, 2021, 11:24:43 PM
    Author     : Dell
--%>
...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
        ...
        <li class="nav-item">
            <a href="admin_customer.jsp" class="nav-link text-dark bg-light">
        ...
        <tbody>
            <%
                try {
                    ...
                    String data;
                    if (qry != null) {
                        data = "select c_name,c_state,c_district,c_city,c_address,c_pin,c_email,c_mob,c_gender from customer where c_name='" + qry + "' or c_state='" + qry + "' or c_district='" + qry + "' or c_city='" + qry + "' or c_address='" + qry + "' or c_pin='" + qry + "' or c_email='" + qry + "' or c_mob='"+qry+"' or c_gender='"+qry+"'";
                    } else {
                        data = "select c_name,c_state,c_district,c_city,c_address,c_pin,c_email,c_mob,c_gender from customer";
                    }
                    res = st.executeQuery(data);
                    while (res.next()) {
            %>
            <tr>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_name")%></td>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_state")%></td>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_district")%></td>  
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_city")%></td>  
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_address")%></td>  
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_pin")%></td>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_email")%></td>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_mob")%></td>
                <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("c_gender")%></td>                                        
            </tr>
            <%
                    }
                } catch (Exception e) {
