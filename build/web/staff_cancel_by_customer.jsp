            ...
            <div class="container-fluid p-0">
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">E-Courier/Cancelled by customer</a>
...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
        <li class="nav-item">
            <a href="staff_cancel_by_customer.jsp" class="nav-link text-dark bg-light">
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th class="col-md-1 col-lg-1 col-xl-1 text-center">Parcel</th>
                <th class="col-md-1 col-lg-1 col-xl-1 text-center">Sended By</th>
                <th class="col-md-1 col-lg-1 col-xl-1 text-center">Return Reason</th>
                <th class="col-md-1 col-lg-1 col-xl-1 text-center">Money Refunded?</th>                
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        ResultSet res;
                        String data;
                        data = "select parcel_cancel.p_id,parcel_cancel.c_id,parcel_details.p_details,customer.c_name,parcel_cancel.pc_reason,parcel_cancel.pc_isrefund from parcel_cancel,parcel_details,customer where parcel_cancel.p_id=parcel_details.p_id and parcel_cancel.c_id=customer.c_id";
                        res = st.executeQuery(data);
                        while (res.next()) {
                %>

                <tr>
                    <td class="col-md-1 col-lg-1 col-xl-1 text-center" hidden="true"><%=res.getString("parcel_cancel.p_id")%></td>
                    <td class="col-md-1 col-lg-1 col-xl-1 text-center" hidden="true"><%=res.getString("parcel_cancel.c_id")%></td>
                    <td class="col-md-3 col-lg-3 col-xl-3 text-center"><%=res.getString("parcel_details.p_details")%></td>
                    <td class="col-md-2 col-lg-2 col-xl-2 text-center"><%=res.getString("customer.c_name")%></td>  
                    <td class="col-md-3 col-lg-3 col-xl-3 text-center"><%=res.getString("parcel_cancel.pc_reason")%></td>  
                    <td class="col-md-1 col-lg-1 col-xl-1 text-center"><%=res.getString("parcel_cancel.pc_isrefund")%></td>                                          
                    <td class="col-md-1 col-lg-1 col-xl-1 text-center">
                        <a href='staff_cancel_by_customer_view.jsp?p_id=<%=res.getString("parcel_cancel.p_id")%>' class="btn btn-warning">View</a>                        
                    </td>
                </tr>
