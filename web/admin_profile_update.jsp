        ...
        <div class="sec" id="sec">
            ...
            <form action="" method="post" onsubmit="return checkpass();">                
                <div style="background-color:#61CACC; align:center;overflow:hidden;"><br>                    
                    <a href="admin_profile_pass.jsp" style="margin-left: 900px;color:black;background-color: pink;border-radius: 20px;" name="btnch">Update Your Password<i class="fas fa-user-shield mr-3 text-primary fa-fw"></i></a>
                    ...
                    <div class="form-group row" style="padding-left: 30px;padding-right: 30px;">                
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="arole" class="form-control" id="arole" maxlength="10" placeholder="Enter Role" required>
                        </div>
                    </div>
                    <div class="form-group row" style="padding-left: 30px;padding-right: 30px;">                
