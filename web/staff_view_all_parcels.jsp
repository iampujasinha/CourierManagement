<%-- 
    Document   : staff_view_all_parcels
    Created on : 19 Oct, 2021, 8:57:47 PM
    Author     : Dell
--%>
            ...
            <div class="container-fluid p-0">
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">E-Courier/View all parcels</a>
...
<div class="vertical-nav bg-white" id="sidebar">
    ...
    <ul class="nav flex-column bg-white mb-0">
        ...
        <li class="nav-item">
            <a href="staff_view_all_parcels.jsp" class="nav-link text-dark bg-light">
            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        ResultSet res;
                        String data;
                        data = "select parcel.p_id,parcel.p_reached_date,parcel.p_cost,parcel.p_payment_mode,customer.c_name,recipient.r_name,parcel_details.p_details from parcel,customer,recipient,parcel_details where parcel.p_id=parcel_details.p_id and parcel.c_id=customer.c_id and parcel.r_id=recipient.r_id";
